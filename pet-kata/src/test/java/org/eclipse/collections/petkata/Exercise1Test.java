...
public class Exercise1Test extends PetDomainForKata
{
    ...
    public void getPeopleWithCats()
    {
        ...
        MutableList<Person> peopleWithCats = this.people.select(person -> person.getPetTypes().contains(PetType.CAT));
    ...
    public void getPeopleWithoutCats()
    {
        ...
        MutableList<Person> peopleWithoutCats = this.people.reject(person -> person.getPetTypes().contains(PetType.CAT));
